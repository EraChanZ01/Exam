    ...
    questionsCardsItem: {
      launchingContest: [
        ...
        },
        {
          ...
          answer: {
            title: "While it is unusually rare that you will not like any names provided, we have a few options in case this problem occurs:",
            value: [
        ...
        },
        {
          ...
          answer: {
            title: "Our creatives have submitted more than 6 Million names and thousands of logos on our platform. Here are some examples of Names, Taglines, and Logos that were submitted in recent contests.",
            value: [
              "Name Examples",
              "Tagline Examples",
              "Logo Examples",
      ...
      ManagedContests: [
        ...
        },
        {
          ...
          answer: {
            title: "The overall process takes 12-13 days.",
            value:[
        ...
        },
        {
          ...
          answer: {
            title: "We offer two levels of Managed Contests. Standard ($1499) and Enterprise ($2999). The Enterprise managed contest includes:",
            value:[
              ...
              "Here is a link to our Pricing page with a detailed comparison of the two packages., the branding consultant will coordinate the detailed Trademark screening (1-3 days)",
            ]
          }
        },
        {
